...
- Total pre-genesis transactions: `5386`
- Total validators: `198`
- Total delegations: `5188`
- Staked tokens: `26460934.37672 (~2.65%)`
...
- address: `tnam1qydvhqdu2q2vrgvju2ngpt6yhrehu525pus6m28p`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `1960376.0155789992 (7.41% of total voting power)`
    - percentage of total supply: `0.2%`
    - email: `info@kintsugi.tech`
    - website: `https://kintsugi.tech`
    - total delegations: `2799`
...
- address: `tnam1qx7apjd6puv09zenlgcjg5q9l74y6ax4sqvyhp6y`
    ...
    - commission: `10.0%`
    - max commission rate change: `1.0%`
    - total voting power: `398424.0 (1.51% of total voting power)`
    - percentage of total supply: `0.04%`
...
- address: `tnam1qy7fms2m4kpx5khvp4x7r3pr8e4xdqghpsrsd0pn`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `344451.92 (1.3% of total voting power)`
    - percentage of total supply: `0.03%`
