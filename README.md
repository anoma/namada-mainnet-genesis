...
- Total pre-genesis transactions: `9214`
- Total validators: `204`
- Total delegations: `9010`
- Staked tokens: `37994538.32672 (~3.8%)`
...
- address: `tnam1q8sjkutd5kqwcc555wr77p9fjn66nuuqfuzzc3yc`
    ...
    - total voting power: `3459529.96 (9.11% of total voting power)`
...
- address: `tnam1qya90eeuaxn47ajfjp08f8zzgjtmhy0lmyxn26gu`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `1481571.611 (3.9% of total voting power)`
...
- address: `tnam1q87f9g34lagl5e6y482fwtad7870rk4vzsqaq7mf`
    ...
    - total voting power: `1203198.0 (3.17% of total voting power)`
...
- address: `tnam1qx2xz8ggmzgfgkj5n33fzumq3lept6hf7yqxcrex`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `1014540.0 (2.67% of total voting power)`
...
- address: `tnam1q8lhvxys53dlc8wzlg7dyqf9avd0vff6wvav4amt`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `1008164.55 (2.65% of total voting power)`
    - percentage of total supply: `0.1%`
...
- address: `tnam1q96k4cmpem5n6tun5qap7vqfxv5fx9hzucp8lqt0`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `1000135.0 (2.63% of total voting power)`
    - percentage of total supply: `0.1%`
...
- address: `tnam1q870s4a5zza2ge5d4lteew3cfp8npu9d2clx5xrv`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `966044.0 (2.54% of total voting power)`
    - percentage of total supply: `0.1%`
...
- address: `tnam1qxsx2ezu89gx252kwwluqp7hadyp285tkczhaqg0`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `914199.5 (2.41% of total voting power)`
...
- address: `tnam1qxr4zeuljyud03wje45d5xu7vass6w7hsuejen2y`
    ...
    - total voting power: `882951.0 (2.32% of total voting power)`
    - percentage of total supply: `0.09%`
...
- address: `tnam1qyep6245as3ar6a6ymk9tvsd6rhdnkr9rgx8mnwl`
    ...
    - commission: `20.0%`
    - max commission rate change: `0.0%`
    - total voting power: `819230.0 (2.16% of total voting power)`
...
- address: `tnam1q8xasrt0q8qrkqj5s9r9xw3ee0gx5mqwyukhe699`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `699402.1799999999 (1.84% of total voting power)`
    - percentage of total supply: `0.07%`
...
- address: `tnam1qxzwta6uhcsv40a8l4g5t07q0ey50c9dlyt3s272`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `664658.4900000001 (1.75% of total voting power)`
    - percentage of total supply: `0.07%`
...
- address: `tnam1qygyng6guhgj7jy4cfe2pxmsle6sakcvqv3cnlg6`
    ...
    - total voting power: `579554.6950000001 (1.53% of total voting power)`
    - percentage of total supply: `0.06%`
...
- address: `tnam1q8f8uln5yv9zx7sgyaakc3fzldm42kjg9y7tpej2`
    ...
    - commission: `10.0%`
    - max commission rate change: `1.0%`
    - total voting power: `553263.0 (1.46% of total voting power)`
    - percentage of total supply: `0.06%`
...
- address: `tnam1qy6y8ws67ks2p5jl53s6yukre554mhwrugdp8vjh`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `511624.0 (1.35% of total voting power)`
...
- address: `tnam1qx64zytr93rjj23ztf32y2rnrxwlm9j6svyznxez`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `500000.0 (1.32% of total voting power)`
    - percentage of total supply: `0.05%`
...
- address: `tnam1q8d8ypu5j88qqvx89grct795uap82dtlqvjqjh3h`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `455770.0 (1.2% of total voting power)`
    - percentage of total supply: `0.05%`
...
- address: `tnam1qxr8n7u36jcf82d0ccp0flshpwhz3d3xjv5ryn44`
    ...
    - commission: `10.0%`
    - max commission rate change: `1.0%`
    - total voting power: `420972.0 (1.11% of total voting power)`
...
- address: `tnam1q8yksf6xqm6u8e2axhy7wyx0elslnh7tdsrp2y9m`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `413609.67 (1.09% of total voting power)`
    - percentage of total supply: `0.04%`
...
- address: `tnam1qyauvf4gmvtthknkrftu9jpjaqn6k0k6nu3jucey`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `401648.0 (1.06% of total voting power)`
    - percentage of total supply: `0.04%`
...
- address: `tnam1q9pt4hukg0ga362jq2slhg4tuf692zqqngzzz54k`
    ...
    - total voting power: `371451.92 (0.98% of total voting power)`
    - percentage of total supply: `0.04%`
...
- address: `tnam1qygz4sn400y9g90rt5jx6ja0wrcx3y7u0c0ue6dq`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `360779.88 (0.95% of total voting power)`
    - percentage of total supply: `0.04%`
    - email: `security@lavenderfive.com`
    - discord: `reversesigh`
    - website: `https://lavenderfive.com`
    - total delegations: `156`
...
- address: `tnam1qyx57588ejm4ltfldr4kvftmcr8plkx7eykxkmsj`
    ...
    - total voting power: `326361.0 (0.86% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qx405kgvey8wwfcyt7rgsr4nvkrqsnztxs2kz7wv`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `261269.0 (0.69% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1q9vrp45qtphed4q2vc382qrtf2gfykf50vssfe2h`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `227150.82 (0.6% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q8s9kj30dhsnw5kvtf0mq2exgyup64l28sxn953p`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `203786.54 (0.54% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q9skz9pj8rac6tnjkcahqw7q68tg5ekgmsxurann`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `104503.0 (0.28% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1qyzcm6jay6u624050fucq3uhfe2r9k8e7qhn65l5`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `62949.0 (0.17% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q9pnpud5ha22twh44y333rcadlx34xflysvhqtw8`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `61230.0 (0.16% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1qxrm6dyrrmwz5thy565jzzuhgs4m02u9t52v9z3g`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `59081.0 (0.16% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1qycjura8y6uceeuh4wtlyyt0pam6av9xegxtvrkz`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `51432.89 (0.14% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1qxq08djyzzrhgchwv2datwhk3cghtseg953ruh2y`
    ...
    - commission: `10.0%`
    - max commission rate change: `10.0%`
    - total voting power: `9960.0 (0.03% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1q9xecndf4dpp83v393myhlzzs2g7g7df2c9cdzll`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `2182.0 (0.01% of total voting power)`
    - percentage of total supply: `0.0%`
