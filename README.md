...
- Staked tokens: `27609555.13672 (~2.76%)`
...
- address: `tnam1q8sjkutd5kqwcc555wr77p9fjn66nuuqfuzzc3yc`
    ...
    - total voting power: `3335953.96 (12.08% of total voting power)`
...
- address: `tnam1qydvhqdu2q2vrgvju2ngpt6yhrehu525pus6m28p`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `2120965.015578999 (7.68% of total voting power)`
...
- address: `tnam1qyx2vmne6th0nfk9lnwdz3mpwzslsaj5xc0x8ucu`
    ...
    - max commission rate change: `1.0%`
    - total voting power: `2056502.0 (7.45% of total voting power)`
    - percentage of total supply: `0.21%`
...
- address: `tnam1q87f9g34lagl5e6y482fwtad7870rk4vzsqaq7mf`
    ...
    - total voting power: `1202292.0 (4.35% of total voting power)`
...
- address: `tnam1qya90eeuaxn47ajfjp08f8zzgjtmhy0lmyxn26gu`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `1029590.611 (3.73% of total voting power)`
...
- address: `tnam1q96k4cmpem5n6tun5qap7vqfxv5fx9hzucp8lqt0`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `1000000.0 (3.62% of total voting power)`
    - percentage of total supply: `0.1%`
...
- address: `tnam1qxsx2ezu89gx252kwwluqp7hadyp285tkczhaqg0`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `825390.0 (2.99% of total voting power)`
...
- address: `tnam1qx7wyapm8f9ddlukz3p7gdmhjjvck7lmaqjeflra`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `724900.0 (2.63% of total voting power)`
...
- address: `tnam1qxzwta6uhcsv40a8l4g5t07q0ey50c9dlyt3s272`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `613851.5900000001 (2.22% of total voting power)`
...
- address: `tnam1qy500vdqtcumxzfhjccrhdx9j9wawhsyg536thwn`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `572187.0 (2.07% of total voting power)`
    - percentage of total supply: `0.06%`
...
- address: `tnam1q8xasrt0q8qrkqj5s9r9xw3ee0gx5mqwyukhe699`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `569880.1799999999 (2.06% of total voting power)`
    - percentage of total supply: `0.06%`
...
- address: `tnam1q8f8uln5yv9zx7sgyaakc3fzldm42kjg9y7tpej2`
    ...
    - commission: `10.0%`
    - max commission rate change: `1.0%`
    - total voting power: `553050.0 (2.0% of total voting power)`
    - percentage of total supply: `0.06%`
...
- address: `tnam1q8wldcr49mhm92a69fmf847d8rn48e6gcql2s4ya`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `509148.0 (1.84% of total voting power)`
...
- address: `tnam1qyf80vw4e8aa2efuk4jsg9lpwxrntsj2dql4tssa`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `485509.0 (1.76% of total voting power)`
    - percentage of total supply: `0.05%`
...
- address: `tnam1qx64zytr93rjj23ztf32y2rnrxwlm9j6svyznxez`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `400000.0 (1.45% of total voting power)`
...
- address: `tnam1qx7apjd6puv09zenlgcjg5q9l74y6ax4sqvyhp6y`
    ...
    - commission: `10.0%`
    - max commission rate change: `1.0%`
    - total voting power: `398424.0 (1.44% of total voting power)`
    - percentage of total supply: `0.04%`
...
- address: `tnam1qx2xz8ggmzgfgkj5n33fzumq3lept6hf7yqxcrex`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `381000.0 (1.38% of total voting power)`
    - percentage of total supply: `0.04%`
...
- address: `tnam1qy6y8ws67ks2p5jl53s6yukre554mhwrugdp8vjh`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `372652.0 (1.35% of total voting power)`
    - percentage of total supply: `0.04%`
...
- address: `tnam1q8d8ypu5j88qqvx89grct795uap82dtlqvjqjh3h`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `355450.0 (1.29% of total voting power)`
    - percentage of total supply: `0.04%`
...
- address: `tnam1q9ctkntly0ggv796axf4flnz3mgtx42ucuh5xhme`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `350000.0 (1.27% of total voting power)`
...
- address: `tnam1qy7fms2m4kpx5khvp4x7r3pr8e4xdqghpsrsd0pn`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `346328.92 (1.25% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qxr8n7u36jcf82d0ccp0flshpwhz3d3xjv5ryn44`
    ...
    - commission: `10.0%`
    - max commission rate change: `1.0%`
    - total voting power: `319842.0 (1.16% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1q9rq7p4wzy6fea96xs5sr8qnsxsfdr2zugfsvw2n`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `316241.92 (1.15% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qygycq5aejv4aypdppldrar2jnplmyt8ussdvjyr`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `300100.0 (1.09% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qy93z8ek2wwm3l3nd9gl872n2argnjfrwstywpmj`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `297865.5 (1.08% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qygyng6guhgj7jy4cfe2pxmsle6sakcvqv3cnlg6`
    ...
    - commission: `5.0%`
    - max commission rate change: `10.0%`
    - total voting power: `294700.695 (1.07% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1q8yksf6xqm6u8e2axhy7wyx0elslnh7tdsrp2y9m`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `290099.67 (1.05% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qx03fx58wtm6e2g5yt4uu9jpy702h4pjuy9a7653`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `281000.0 (1.02% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qy0zrla88txv244suxaruqgr9g74vr8vyufd8rp7`
    ...
    - total voting power: `279932.0 (1.01% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qygz4sn400y9g90rt5jx6ja0wrcx3y7u0c0ue6dq`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `277180.0 (1.0% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qx6k7xv66y58jw2jngtt98x0r9k3wtljxqd7qe2l`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `272529.0 (0.99% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1q9pt4hukg0ga362jq2slhg4tuf692zqqngzzz54k`
    ...
    - commission: `5.0%`
    - max commission rate change: `2.0%`
    - total voting power: `270264.8 (0.98% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qx405kgvey8wwfcyt7rgsr4nvkrqsnztxs2kz7wv`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `260083.0 (0.94% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qyx57588ejm4ltfldr4kvftmcr8plkx7eykxkmsj`
    ...
    - total voting power: `250226.0 (0.91% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1q8usghsv57lyfr26wtpyx9ry8v5h9lq63uakqupt`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `250000.0 (0.91% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qy3m25cx7gd67vyz5px5wjj5gcy4pfhnnux9mhcr`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `243337.0 (0.88% of total voting power)`
...
- address: `tnam1q829u6jedv7y4yek2gfrh77qaz9qe3veduzkdyk4`
    ...
    - commission: `3.0%`
    - max commission rate change: `1.0%`
    - total voting power: `240000.0 (0.87% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q8pueqy3yqmntt4k25ld5v0ljp87me8flg7pkvde`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `231784.6300000007 (0.84% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q8s9kj30dhsnw5kvtf0mq2exgyup64l28sxn953p`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `201897.54 (0.73% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q8hck7594xqw9dz35m8wwtgtvdxf4xn0mg908r8x`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `201250.0 (0.73% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q9vrp45qtphed4q2vc382qrtf2gfykf50vssfe2h`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `183964.82 (0.67% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q8dtazgc7y9xx00lq4d2pnacvtz29p5mvcxwat74`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `178778.0 (0.65% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q93th4stcuxfs0h8kn9uw0uhdj59dfa5hu768v4t`
    ...
    - commission: `7.000000000000001%`
    - max commission rate change: `1.0%`
    - total voting power: `167908.0 (0.61% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q8qt5qy99fvuhltq3pg20k223crauw6phulv0kfj`
    ...
    - commission: `5.0%`
    - max commission rate change: `3.0%`
    - total voting power: `161221.0 (0.58% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q8qr408fvssqpqaht2qspryq2yfu7lds0urktcam`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `153384.0 (0.56% of total voting power)`
    - percentage of total supply: `0.02%`
...
- address: `tnam1q98f4snsa7r5lmkc9d66k29r4m0eqpv2j5f7vw8d`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `140058.0 (0.51% of total voting power)`
...
- address: `tnam1q8cfpdka8ddcwyxkaf7sjtpdg3xrv5j9pq5rv70w`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `125100.0 (0.45% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q96knx9lhndg9749waeqq974zyqxz8yv0slmy39v`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `119000.0 (0.43% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q8jrrf8s22cwd22yxhwc38tlvahplh2wyqjzl9gx`
    ...
    - total voting power: `117465.0 (0.43% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q96m7kwchdgzjk7dpvxkq3dxwzjhyjcggyuua5xf`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `100000.0 (0.36% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q9skz9pj8rac6tnjkcahqw7q68tg5ekgmsxurann`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `99623.0 (0.36% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q985emxj29hpz3dlye0yfe5hm66pmwqalu0y06p4`
    ...
    - total voting power: `84180.0 (0.3% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q9sdarpylwxd5vv3e8u6wstrpz052jhls5g4a3wg`
    ...
    - commission: `0.0%`
    - max commission rate change: `2.5%`
    - total voting power: `80511.88 (0.29% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q8tzr86aw8kh2f66vukkhnghppkp0xckdy3xzrgx`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `77400.0 (0.28% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q89xnpnrfsefr9ynj4v8ngdu35me8xudzgn94afm`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `73184.85 (0.27% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1q8qkkdq9wvpk0udfaf64cswzpnwe033jpvcmrxz6`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `66600.0 (0.24% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1qy9jra0mueg9637r0wlxehecrj0ale9ldgrytymm`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `55805.0 (0.2% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1qxuv9e6rx0stfz7e842q4uwmpcexh50765qqw9ns`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `50045.67 (0.18% of total voting power)`
    - percentage of total supply: `0.01%`
...
- address: `tnam1qx304q35wkfd5zd07rgapwsrmg3tsapncsqdcg25`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `48614.40999999999 (0.18% of total voting power)`
...
- address: `tnam1qxkkaflgfr6c7crvj4jwshy99zsdw346nv4ay0rn`
    ...
    - commission: `5.0%`
    - max commission rate change: `10.0%`
    - total voting power: `47782.0 (0.17% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1q9mgfvqqypw82jk997kzgkkgnf8fxur2qqpa7rlr`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `47726.0 (0.17% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1qyxd5eh0mf49at77dursxnlsygn5se6d45tj5y47`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `46857.68 (0.17% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1qxfcew76uclxuf5a5qkhwdtt8m6enc58tsqnwupd`
    ...
    - total voting power: `44901.0 (0.16% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1q9cfj43flxq0tlh4vlaymjcea9g5mm2qhqls99ky`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `42501.0 (0.15% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1q8236gr76rrsluvq27j8mkma8u04hz0khszatckw`
    ...
    - commission: `5.0%`
    - max commission rate change: `5.0%`
    - total voting power: `41277.0 (0.15% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1q80ajrpqzv0vz9sl5ye22rprjt3k3q0cqy4lwywe`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `40847.42 (0.15% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1qxp569pkgds6kzqfe9cuc65mupjwamtghc433m82`
    ...
    - commission: `5.0%`
    - max commission rate change: `10.0%`
    - total voting power: `40080.0 (0.15% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1qyl2fc8c358avg47ff5lkc47d4cnk0x8wy96ax9q`
    ...
    - commission: `1.0%`
    - max commission rate change: `1.0%`
    - total voting power: `38682.0 (0.14% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1qxtfny8cngyyf0ms2fl6rcu65lt0da0ns5a3gxrq`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `32854.0 (0.12% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1q8t4hkv7dqjkka7ns42rramvz0dmj98g7q7zq67m`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `29100.0 (0.11% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1qyx7d7vm30tgf3fj4awa60syk9rhcjv8uulhkpq5`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `21825.0 (0.08% of total voting power)`
    - percentage of total supply: `0.0%`
...
- address: `tnam1qyfmtehvnrrcwtjueygvvqrwy43dtw3r9uwe5tf7`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `21261.0 (0.08% of total voting power)`
    - percentage of total supply: `0.0%`
