...
- Total pre-genesis transactions: `5421`
- Total validators: `202`
- Total delegations: `5219`
- Staked tokens: `27060543.13672 (~2.71%)`
...
- address: `tnam1qydvhqdu2q2vrgvju2ngpt6yhrehu525pus6m28p`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `1963202.0155789992 (7.25% of total voting power)`
...
- address: `tnam1qy7fms2m4kpx5khvp4x7r3pr8e4xdqghpsrsd0pn`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `344451.92 (1.27% of total voting power)`
    - percentage of total supply: `0.03%`
...
- address: `tnam1qxepvwg3c24kv0ltlkaasxscy3fsk89h8vrwzgd7`
    ...
    - commission: `5.0%`
    - max commission rate change: `1.0%`
    - total voting power: `16091.8 (0.06% of total voting power)`
    - percentage of total supply: `0.0%`
